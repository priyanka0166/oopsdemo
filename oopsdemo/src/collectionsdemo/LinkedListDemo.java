...
public class LinkedListDemo {
	...
	public static void main(String[] args) {
        ...
        System.out.println("\nSearch a friend in position 3: "+friends.get(3));
        
        System.out.println("Remove Rajeev from the friend list: "+friends.remove("Rajeev"));
        System.out.println("\nFriend's List: \n"+friends);
        
        System.out.println("\nPosition of Lisa: "+friends.indexOf("Lisa"));
