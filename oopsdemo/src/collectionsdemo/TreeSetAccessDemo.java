...
public class TreeSetAccessDemo {
	...
	public static void main(String[] args) {
		//sorts the elements by ignoring the case -- CASE_INSENSITIVE_ORDER
        ...
        System.out.println("\nNumber of elements in the TreeSet : " + students.size());
        ...
        System.out.println("\nFirst element : " + students.first());
        System.out.println("Last element : " + students.last());

        name = "Robert";
        System.out.println("\nElement just greater than "  + name + " : " + students.higher(name));
